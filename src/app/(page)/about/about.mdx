...
<RoleLabel roles={[{ title: "Sr. Frontend Engineer", years: "2022 - Present" }]} />
...
<RoleLabel
    roles={[
        { title: "Lead Front-End Developer", years: "2020 - 2022" },
        { title: "Sr. Front-End/Full-Stack Developer", years: "2019 - 2020" },
    ]}
/>
...
-   Leading front-end development on two projects with 4+ front-end developers, within multidisciplinary team of 20+.
    ...
    -   4D Nucleome Data Portal ([data.4dnucleome.org](https://data.4dnucleome.org)) (see portfolio) - A successor to the human genome project; used by thousands of DNA researchers around the world.
...
-   8+ years experience building front-ends/apps with [React.js](https://facebook.github.io/react/), plus 3 months w/ React Native.
-   5+ years experience with [NodeJS](https://nodejs.org/en), including server-side-rendering (SSR) using classic approaches.
-   ~1 year experience with [NextJS](https://nextjs.org/) for SSR and static site generation (SSG).
...
#### OOP & FP back-end development with [Python](http://python.org/), Java Spring, [PHP](http://php.net/), [C#](<http://wikipedia.org/wiki/c_sharp_(programming_language)>) (+ [.NET](http://microsoft.com/net), & [XAML](http://en.wikipedia.org/wiki/Extensible_Application_Markup_Language))
